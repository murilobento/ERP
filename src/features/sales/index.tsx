    ...
    <SalesProvider>
      ...
      <Main className='flex flex-1 flex-col gap-3 sm:gap-6'>
        ...
        <div className='grid gap-2 sm:grid-cols-2 lg:grid-cols-4'>
          ...
          <Card className='border-blue-200 bg-blue-50 p-2.5 sm:p-3 dark:border-blue-800 dark:bg-blue-950'>
            <div className='flex min-w-0 items-center justify-between gap-2'>
              <div className='min-w-0'>
          ...
          <Card className='border-green-200 bg-green-50 p-2.5 sm:p-3 dark:border-green-800 dark:bg-green-950'>
            <div className='flex min-w-0 items-center justify-between gap-2'>
              <div className='min-w-0'>
                <p className='text-sm font-medium text-green-600 dark:text-green-400'>
                  Pagos
                </p>
                <div className='text-xl font-bold text-green-700 sm:text-2xl dark:text-green-300'>
          ...
          <Card className='border-red-200 bg-red-50 p-2.5 sm:p-3 dark:border-red-800 dark:bg-red-950'>
            <div className='flex min-w-0 items-center justify-between gap-2'>
              <div className='min-w-0'>
                <p className='text-sm font-medium text-red-600 dark:text-red-400'>
                  A Receber
                </p>
                <div className='text-xl font-bold text-red-700 sm:text-2xl dark:text-red-300'>
        ...
        >
          <TabsList className='h-8'>
            <TabsTrigger
              value='table'
              className='flex-none gap-1 px-2 py-1 text-xs'
            >
